...
SECRET_KEY = 'django-insecure-*@x$)vfr=4g8nve*f+@i!1a%1y21h+)5r!rymui)n^)q-7(4^*'
...
#For Custom USER
AUTH_USER_MODEL = "TaskManagement_app.CustomUser"
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'bh.shruthi224@gmail.com'
EMAIL_HOST_PASSWORD = 'hbutkxqrodpzwmog' 